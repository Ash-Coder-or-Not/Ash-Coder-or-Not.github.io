...
> "Good design is as little design as possible." <br> - some German motherfucker

---

## Epilogue
From the philosophies expressed (poorly) above, [txti](https://txti.es/) was created. You should try it today to make your own motherfucking websites.

---

This was shamelessly copied from motherfuckingwebsite.com, because although i may not follow it as much as i should, i still like it.
